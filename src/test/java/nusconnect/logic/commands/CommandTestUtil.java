...
public class CommandTestUtil {
    ...
    public static final String INVALID_ALIAS_DESC = " " + PREFIX_ALIAS + "&&&"; // '&' not allowed in aliases
    public static final String INVALID_COURSE_DESC = " " + PREFIX_COURSE + "CS & IS"; //'&' not allowed in courses
    public static final String INVALID_WEBSITE_DESC = " " + PREFIX_WEBSITE + "invalidwebsite"; // is not a URL
