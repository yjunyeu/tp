...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY
                        + NAME_DESC_AMY + ALIAS_DESC_AMY + MAJOR_DESC_ANY + NOTE_DESC_AMY
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ALIAS,
                        PREFIX_MAJOR, PREFIX_NOTE, PREFIX_TELEGRAM, PREFIX_WEBSITE));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ALIAS_DESC_AMY
                + MAJOR_DESC_ANY + NOTE_DESC_AMY + TELEGRAM_DESC_AMY + WEBSITE_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ALIAS_DESC_BOB
                + MAJOR_DESC_BOB + NOTE_DESC_BOB + TELEGRAM_DESC_BOB + WEBSITE_DESC_BOB, expectedMessage);
        ...
        // missing note prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ALIAS_DESC_BOB
                        + MAJOR_DESC_BOB + VALID_NOTE_BOB + TELEGRAM_DESC_BOB + WEBSITE_DESC_BOB,
                expectedMessage);

        // missing telegram prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ALIAS_DESC_BOB
                        + MAJOR_DESC_BOB + NOTE_DESC_BOB + VALID_TELEGRAM_BOB + WEBSITE_DESC_BOB,
                expectedMessage);

        // missing website prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ALIAS_DESC_BOB
                        + MAJOR_DESC_BOB + NOTE_DESC_BOB + TELEGRAM_DESC_BOB + VALID_WEBSITE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ALIAS_BOB
                + VALID_MAJOR_BOB + VALID_NOTE_BOB + VALID_TELEGRAM_BOB + VALID_WEBSITE_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_stillSuccess() {
        ...
        assertParseSuccess(parser,
                INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ALIAS_DESC_BOB + MAJOR_DESC_BOB
                        + NOTE_DESC_BOB + TELEGRAM_DESC_BOB + WEBSITE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
