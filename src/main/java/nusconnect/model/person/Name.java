...
public class Name {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Names should only contain alphanumeric characters, slashes, apostrophes, dashes, dots, "
                    + "and it should not be blank! The first character should be alphanumeric";
